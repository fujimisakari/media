...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.thumbnail_volume'
        db.add_column('book_book', 'thumbnail_volume',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.thumbnail_volume'
        db.delete_column('book_book', 'thumbnail_volume')
