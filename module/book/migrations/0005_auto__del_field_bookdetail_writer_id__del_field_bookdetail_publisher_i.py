...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BookDetail.writer_id'
        db.delete_column('book_bookdetail', 'writer_id')

        # Deleting field 'BookDetail.publisher_id'
        db.delete_column('book_bookdetail', 'publisher_id')


    def backwards(self, orm):
        # Adding field 'BookDetail.writer_id'
        db.add_column('book_bookdetail', 'writer_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'BookDetail.publisher_id'
        db.add_column('book_bookdetail', 'publisher_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)
