...
from module.manage.view_book import book_index, book_add, book_edit, book_delete, book_delete_checked, book_search
...
urlpatterns = patterns(
    ...
    url(r'^book/regist/(?P<set_type>\w+)/$', book_add, name='manage_book_add'),
